...
import com.bigOne.trainerstayfit.databinding.ListMyCourseItemBinding
import com.bigOne.trainerstayfit.datas.model.CourseData
import com.bumptech.glide.Glide

class MyCourseAdapter(var mList: MutableList<CourseData>, private  val context: Context) : RecyclerView.Adapter<MyCourseAdapter.WorkoutViewHolder>() {
    var onitemClickListner: OnItemClickListener? = null
    inner class WorkoutViewHolder(private val binding: ListMyCourseItemBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WorkoutViewHolder {
        val binding = DataBindingUtil.inflate<ListMyCourseItemBinding>(
            LayoutInflater.from(parent.context),
            R.layout.list_my_course_item,
            parent,
            false
        )
